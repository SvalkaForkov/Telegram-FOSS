...
**Important:**
1. You need the [Android NDK, Revision 14b (March 2017)](https://developer.android.com/ndk/downloads/older_releases) and [Ninja](https://ninja-build.org/) to build the apk.
